...
public class SessaoVotacaoController {
	...
	public SessaoVotacaoModel abrirSessao(@Valid @RequestBody SessaoVotacaoInput sessaoVotacaoInput) {
	...
	private SessaoVotacaoModel toModel(SessaoVotacao sessaoVotacao) {
		sessaoVotacao.setVotos(sessaoVotacaoService.buscarVotos(sessaoVotacao.getId()));
